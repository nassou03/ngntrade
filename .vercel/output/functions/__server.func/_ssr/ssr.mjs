...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CrAoSeU_.mjs");
...
var manifest = {
	"49e390d9bf5618ec9f7d49d5eae8ebb4c93820eb250625e8501a7cb25708cdc5": {
		functionName: "analyzeChart_createServerFn_handler",
		importer: () => import("./server-Cpavgvsn.mjs")
	},
	"bd89eb35a216569b66a0fbcc87e7bdddd9a91bb624a6db640ad2d17bd5b88994": {
		functionName: "askCopilot_createServerFn_handler",
		importer: () => import("./server-Cpavgvsn.mjs")
	},
	"fcf76b8becc651d4310caa9328bc51371066ed5c24815216cdd465822b1319f8": {
		functionName: "getMarketQuotes_createServerFn_handler",
		importer: () => import("./quotes-c120Bq26.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DDtmUGdU.mjs").then((n) => n.t),
